            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group mb-4">
                  <label class="label">Customers Name</label>
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Write your Customers name"
                  />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group mb-4">
                  ...
                  <input
                    type="dte"
                    class="form-control"
                    placeholder="Write your issued date"
                  />
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group mb-4">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Write total amount"
                  />
                </div>
              </div>
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <button type="submit" class="default-btn cancel ms-3">
                    Cancel
                  </button>
                </div>
              </div>
